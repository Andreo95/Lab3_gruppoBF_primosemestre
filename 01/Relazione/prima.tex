...
\graphicspath{ {../} } % graphics search directories
...
\sisetup{separate-uncertainty = true, per-mode = symbol, bracket-numbers = false, multi-part-units = single}

\title{Relazione di laboratorio \\ }
\author{Browne Roberto \and Lomanto Valerio \and Staiano Alessandro}
\date{30 Ottobre 2014}
\maketitle

\section{Obiettivo dell'esperimento}

\section{Misura tensione e corrente}
\subsection{b}

\subsection{c}
Analogico sulla differenza bassa. Opinabile?
\subsection{d}
...
%...
\section{Misura di frequenza e tempo}

\section{Trigger oscilloscopio} 
\end{document}