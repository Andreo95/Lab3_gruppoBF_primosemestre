...
\sisetup{separate-uncertainty = true, per-mode = symbol, bracket-numbers = false, multi-part-units = single, table-number-alignment = center, range-phrase = \text{--}, range-units = brackets, output-complex-root =  \text{\ensuremath{j}} }
...
\insertpart{parte1}{} % intro e parte 1 (V: dovrei aver detto tutto)

\insertpart{parte2}{} % parte 2 (TODO: errori vari)

\insertpart{parte3}{valerio} % parte 3
\insertpart{parte4}{} % parte 4
\end{document}