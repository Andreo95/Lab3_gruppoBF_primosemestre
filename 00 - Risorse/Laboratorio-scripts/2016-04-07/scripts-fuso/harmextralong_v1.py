...
FileName=Directory+'smorzextralong.txt'  # parte comune nome file << DA CAMBIARE SECONDO NECESSITA'
...
for i in range (0,256):
    data = ard.readline().decode() # legge il dato e lo decodifica
    if data:
        outputFile.write(data) # scrive i quarti 256 in file
print ("Part 4/8 done")             
for i in range (0,256):
    data = ard.readline().decode() # legge il dato e lo decodifica
    if data:
        outputFile.write(data) # scrive i quinti 256 in file
print ("Part 5/8 done")
for i in range (0,256):
    data = ard.readline().decode() # legge il dato e lo decodifica
    if data:
        outputFile.write(data) # scrive i sesti 256 in file
print ("Part 6/8 done")        
for i in range (0,256):
    data = ard.readline().decode() # legge il dato e lo decodifica
    if data:
        outputFile.write(data) # scrive i settimi 256 in file
print ("Part 7/8 done") 
for i in range (0,256):
    data = ard.readline().decode() # legge il dato e lo decodifica
    if data:
        outputFile.write(data) # scrive gli ottavi 256 in file
print ("Part 8/8 done")             
