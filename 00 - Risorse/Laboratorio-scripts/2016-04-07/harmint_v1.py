...
Directory='../Data/'   # nome directory dati
                                                    # << DA CAMBIARE SECONDO NECESSITA'
FileName=Directory+'intlvd_12lgnpie.txt'  # parte comune nome file << DA CAMBIARE SECONDO NECESSITA'
...
ard.write(b'3') # scrive il carattere per l'intervallo di campionamento
