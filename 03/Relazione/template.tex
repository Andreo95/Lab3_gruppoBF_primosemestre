...
%\usepackage{fixltx2e} % provides \textsubscript and makes some fixes %obsolete
...
%nome file, persona, inizio, fine
\newcommand{\insertpart}[4]{\input{#1}}

%%% --- DOCUMENT --- %%%


\sisetup{separate-uncertainty = true, per-mode = symbol, bracket-numbers = false, multi-part-units = single, table-number-alignment = center}
...
\begin{document}
\maketitle
\insertpart{introduzione}{}{inizio}{Misure DC sul transistor punto e}
\insertpart{parte2}{}{6.a}{6.d}
\end{document}