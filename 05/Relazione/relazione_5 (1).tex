...
\insertpart{parte1}{} % inizio e prima parte, con casini su IDSS


\insertpart{parte2}{} %punto 2 dell'esperienza
%ho inserito la figura del secondo circuito nella parte 2

\insertpart{parte3}{andrea}% punto 3 LUZIO SMETTILA DI PUSHARE IL RELAZIONE.TEX VECCHIO PLS
% (esiste \fig{}) -V
% occhio che l'errore su gm è più grande di quanto c'era prima

\insertpart{parte4}{Valerio} % punto 4
\insertpart{parte5}{gianfranco}%punto 5  motivo per cui non torna il guadagno???
\end{document}